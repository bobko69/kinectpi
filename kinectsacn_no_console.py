...
# global variables
ipaddress = "4.3.2.1" #wleds ipaddress
universecount = 16
screen_width = 48
screen_height = 56

#use wpa-supplicant to connect wifi to WLED
#crontab -e @reboot python3 /home/pi/kinectpi/kinectsacn_no_console.py 
...
#this function sends the sacn to wled
...
def main():
    ...
    while True: # the main game loop
        depth = np.rot90(get_depth()[0]) # get the depth readings from the kinect
